...
from exp.exp_SREMC_MoE import Exp_SREMC_MoE
...
if __name__ == '__main__':
    ...
    print(f"Using random seed: {fix_seed}")
    ...
    parser = argparse.ArgumentParser(description='[SREMC-MoE] Time Series Forecasting')
    ...
    parser.add_argument('--model', type=str, required=True, default='NLinear',
                        help='model name, options: [NLinear, TCN, PatchTST, SREMC_MoE, DLinear]')
    ...
    parser.add_argument('--padding_patch', type=str, default='end', help='padding patch method')
    parser.add_argument('--revin', type=int, default=1, help='RevIN; True 1 False 0')
    parser.add_argument('--affine', type=int, default=0, help='RevIN affine; True 1 False 0')
    parser.add_argument('--subtract_last', type=int, default=0, help='0: subtract mean; 1: subtract last')
    parser.add_argument('--decomposition', type=int, default=0, help='decomposition strategy')
    parser.add_argument('--kernel_size', type=int, default=25, help='decomposition kernel size')
    
    parser.add_argument('--individual', action='store_true', default=False, help='individual head; True 168, False 336')
